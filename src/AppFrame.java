...
public class AppFrame {
	...
	private int[] prime = new int[2500];
	...
	public void activate() {
		...
		addComponent(label1, panel1, 0, 0, 2);
		addComponent(label2, panel1, 0, 1, 1);
		addComponent(scroll1, panel1, 0, 2, 1);
		addComponent(button1, panel1, 0, 3, 1);
		addComponent(button2, panel1, 0, 4, 1);
		addComponent(scroll2, panel1, 1, 2, 1);
		addComponent(button3, panel1, 1, 3, 1);
	 ...
	 * position.
	 * 
	 * @param component: component to be added panel: JPanel to locate the component
	 * x: abscissa-coordinate of the component y: ordinate-coordinate of the
	 * component width: width of the component
	 * 
	 * Precondition: - Component, panel, abscissa-coordinate, ordinate-coordinate,
	 * and width are specified. Postcondition: - A specified component is added to a
	 * specified JPanel in a specified position.
	 */
	...
	public void readInPrime() throws FileNotFoundException {
		...
		while (scanner.hasNextInt()) {
			/*
			 * If the number in the file is i+1, the next element is prime, so insert it to
			 * a specified index in the array "prime."
			 */
	...
	/*
	 * This method displays the list of multiplicity of Godlbach numbers in a
	 * JtextArea.
	 * 
	 * Precondition: - The main JFrame has already been created. - The array "list"
	 * has already been filled. Postcondition - Multiplicity of each Goldbach number
	 * is displayed on an JTextArea.
	 */
	...
	/*
	 * This method displays the list of gaps between two consecutive non-unique sums
	 * in a JtextArea.
	 * 
	 * Precondition: - The main JFrame has already been created. - The ArrayList
	 * "gap" has been filled. Postcondition: - A sequence of gap between non-unique
	 * sums is displayed on a JTextArea.
	 */
	 ...
	 * 
	 * Precondition: - The array "list" has already been created. - The array
	 * "prime" has already been filled. Postcondition: - The array "list" is filled
	 * with multiplicity of each Godlbach number.
	 */
	private void makeList() {
		 ...
		 * "first" to be each prime number. This loop starts from 3 instead of 2 because
		 * 2 appears only in finding the multiplicity of 4.
		 */
		for (int i = 1; i < 2500; i++) {
			first = prime[i];

			/*
			 * This inner loop traverse the rest of the list, setting the variable "second"
			 * to be each prime number.
			 */
			for (int e = i; e < 2500; e++) {
				...
				/*
				 * If the sum is not bigger than the maximum Goldbach number allowed to be in
				 * the array, increment the multiplicity of the sum by 1.
				 */
	...
	/*
	 * This inner class implements an ActionListener of a button to display the gaps
	 * between non-unique sums.
	 */
	 ...
	 * non-unique sums.
	 * 
	 * Precondition: - The ArrayList "gap" has already been created. - The array
	 * "list" has already been filled. Postcondition: - The ArrayList "gap" is
	 * filled.
	 */
	private void countGap() {
		...
		for (int i = 0; i < list.length; i++) {
			/*
			 * If the multiplicity is not 1, this is the end of the sequence of unique sums.
			 */
			if (list[i] != 1) {
				/*
				 * If this is not the first non-unique sums, the length of gap can be found.
				 */
				if (index != -1) {
					gap.add(i - index - 1);
				}
	...
	/*
	 * This inner class implements an ActionListener of a button to display the
	 * graph of multiplicity of Goldbach numbers.
	 */
